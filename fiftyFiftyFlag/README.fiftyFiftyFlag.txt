BZFlag Server Plugin: fiftyFiftyFlag
================================================================================
...
fiftyFiftyFlag directory to a new name, and then manually replace fiftyFiftyFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin fiftyFiftyFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin fiftyFiftyFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin fiftyFiftyFlag,<configfilename>
For example:
  -loadplugin fiftyFiftyFlag,/path/to/my/sampleplugin.cfg
